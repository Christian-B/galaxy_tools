...
def countFrequency(input_path, output_path, seperator, max_options,
                   has_header):
...
if __name__ == '__main__':
    ...
    help = "Path to file, where the output should be written. "
    help += "Defaults to counts.tsv"
    ...
    parser.add_option("--header", action="store_true", dest="has_header",
                      help=help)
    help = "Maximum number of different values to count per column. "
    help += "Must be a positive integer. Default is 10."
    ...
    group.add_option("-a", "--ascii_seperator", dest="ascii_seperator",
                     help="ASCii code of seperator")
    group.add_option("-s", "--seperator", dest="seperator",
    ...
    countFrequency(args[0], options.output_path, seperator, max_options,
                   options.has_header)
